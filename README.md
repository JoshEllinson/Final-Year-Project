...
Once all the datasets have ran and the program has completed you will be able to view TSP_Results.csv separately which will contain all the results in csv format.
